...
class MapCoords:
    def __init__(self, map_title:str, _id:str, layer:str):
        ...
        self.id = _id
        self.layer = layer
        self.__url = 'http://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png'


    @property
    def map_layout(self):   
            return  dl.Map([dl.TileLayer(url=self.__url), dl.LayerGroup(children=[
                ...
                id=self.id, style={'width': '100%', 'height': '50vh', 'margin': "auto", "display": "block", "z-index": "0"})