    ...
    [
        ...
        html.Div([
            ...
            html.Div(children=[
                ...
                dbc.Row([
                    html.Button('Predecir..', id='id_filtrar'),
                ], className="card"),
...
def update_map(selector_municipio, selector_year, nclicks):
    df_filtrado = mapa_colombia_departamentos.df[
        mapa_colombia_departamentos.df['DEPARTAMENTO'].isin(selector_municipio)]
